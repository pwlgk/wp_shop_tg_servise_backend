...
Revision ID: d5660f70fb07
Revises: 95669a224c34
Create Date: 2025-10-13 21:23:49.068751
...
revision: str = 'd5660f70fb07'
down_revision: Union[str, Sequence[str], None] = '95669a224c34'
...
def upgrade() -> None:
    ...
    sa.Column('level', sa.String(length=255), server_default='bronze', nullable=False),
